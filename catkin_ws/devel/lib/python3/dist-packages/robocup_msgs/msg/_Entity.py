...
"""autogenerated by genpy from robocup_msgs/Entity.msg. Do not edit."""
import codecs
import sys
...
class Entity(genpy.Message):
  _md5sum = "602e1507bca7794045dcb939ed5c2edf"
  _type = "robocup_msgs/Entity"
...
float64 w
"""
  __slots__ = ['header','pose','uuid','label','type','diameter','payload']
  _slot_types = ['std_msgs/Header','geometry_msgs/Pose','string','string','string','float32','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,pose,uuid,label,type,diameter,payload
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.diameter,) = _get_struct_f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
