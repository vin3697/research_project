...
"""autogenerated by genpy from robocup_msgs/EntityList.msg. Do not edit."""
import codecs
import sys
...
class EntityList(genpy.Message):
  _md5sum = "db8ccf1a9c056b13ad14402a91f0a4cf"
  _type = "robocup_msgs/EntityList"
...
float64 w
"""
  __slots__ = ['header','entityList']
  _slot_types = ['std_msgs/Header','robocup_msgs/Entity[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(EntityList, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.entityList)
      buff.write(_struct_I.pack(length))
      for val1 in self.entityList:
        _v1 = val1.header
        _x = _v1.seq
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (val1.diameter,) = _get_struct_f().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
