...
(cl:defmethod cl:initialize-instance :after ((m <GotoPoseGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GotoPoseGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tb_msgs-msg:<GotoPoseGoal> is deprecated: use tb_msgs-msg:GotoPoseGoal instead.")))

(cl:ensure-generic-function 'goal_pose-val :lambda-list '(m))
(cl:defmethod goal_pose-val ((m <GotoPoseGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tb_msgs-msg:goal_pose-val is deprecated.  Use tb_msgs-msg:goal_pose instead.")
  (goal_pose m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GotoPoseGoal>)))
  ...
  "a39869a5ab6c3a1eb6058b519a2836ed")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GotoPoseGoal)))
  "Returns md5sum for a message object of type 'GotoPoseGoal"
  "a39869a5ab6c3a1eb6058b519a2836ed")
